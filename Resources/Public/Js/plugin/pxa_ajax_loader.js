PxaAjaxLoader = (function () {
	...
	PxaAjaxLoader.prototype = {
				...
				this._sendAjax(
					...
					function (element, responseText) {
						if (typeof responseText === 'string') {
							...
							element.classList.remove(that._getInLoadingClassName());
						}
					}
				);
			}
		...
		/**
		 * Get dom class name while it's in loading process
		 * @returns string
		 * @private
		 */
		_getInLoadingClassName: function () {
			return this.settings.inLoadingClass || '';
		}
	};
